...
Now you can call the method, 'cachola_get_something_that_takes_a_long_time,' and the return 
value of 'get_something_that_takes_a_long_time' will be cached automatically.

The cached method is then expired automatically when the class in which the plugin has been included
...
saved or destroyed. I thought of that too. It's the other thing I wanted to make easier. Rather than setting up
...
ActsAsCachola is hosted on Github: "http://github.com/rbrant/acts_as_cachola":http://github.com/rbrant/acts_as_cachola, 
where your contributions, forkings, comments and feedback are greatly appreciated. Please do add tests if you want me to 
pull in any changes.
